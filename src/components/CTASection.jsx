...
export default function CTASection({
  ...
  title = "Let’s Build Something Your Competitors Can’t Ignore.",
  description = "Tell us where your business is today. We’ll help you plan where it could be next.",
  primaryLabel = "Book a Free Strategy Call",
  primaryPath = "/book-consultation",
  secondaryLabel = "Explore Our Work",
  secondaryPath = "/portfolio",
  withLogoRebuild = false,
}) {
  return (
      ...
      <FadeIn className="mx-auto max-w-6xl overflow-hidden rounded-lg border border-white/10 bg-[linear-gradient(135deg,rgba(30,64,175,0.3),rgba(11,18,32,0.94),rgba(0,208,132,0.14))] p-8 shadow-glow md:p-12">
        <div className="grid gap-8 md:grid-cols-[0.95fr_1.05fr] md:items-center">
          ...
          <div className="relative flex items-center justify-center">
            {withLogoRebuild ? (
              <div id="final-logo-anchor" aria-hidden="true">
                <img
                  id="final-logo-img"
                  src="/assets/selmore-digital-logo.jpeg"
                  alt="Selmore Digital Rebuilt Logo"
                />
              </div>
            ) : (
              <>
